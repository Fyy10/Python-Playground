...
class TestRandomShuffle(unittest.TestCase):
    ...
    def test_input_not_mutated(self):
        ...
        l = list(range(100))
        random_shuffle(l)
        self.assertEqual(list(range(100)), l)
